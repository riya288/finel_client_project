...
$select = "SELECT * FROM root_category  WHERE root_category_id = '{$root_category_id}'";
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="breadcrumb-content">
                    <h1 class="breadcrumb-hrading"><?= $root_category ?> </h1>
                    <ul class="breadcrumb-links">
                        <li><a href="index.php">Home</a></li>
                        <li><a><?= $root_category ?> </a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                ...
                <div class="shop-top-bar">
                    ...
                    <?php
                    $select = "SELECT * FROM product WHERE root_category_id  = '{$root_category_id}'";
                    $run = mysqli_query($conn, $select);
                                ...
                                while ($data = mysqli_fetch_array($run)) {
                                    ...
                                    <div class="col-xl-3 col-md-2 col-sm-6">
                                        <article class="list-product">
                                            <div class="img-block">
                                                <a href="single_product.php?pro_id=<?php echo $data['pro_id']; ?>"
                                                   class="thumbnail">
                                                    <img class="first-img"
                                                         src="admin/upload/product/<?php echo $data['pro_image']; ?>"
                                                         alt=""/>
                                                    <img class="second-img"
                                                         src="admin/upload/product/<?php echo $data['pro_image2']; ?>"
                                                         alt=""/>
                                                </a>
                                            ...
                                            <div class="product-decs">
                                                ...
                                                <h2><a href="single_product.php?pro_id=<?php echo $data['pro_id']; ?>"
                                                       class="product-link"><?php echo $data['pro_name']; ?></a></h2>
                                                <a class="inner-link"
                                                   href="single_product.php?pro_id=<?php echo $data['pro_id']; ?>"><span><?php echo $data['pro_short_description']; ?></span></a>
                                            ...
                                            <div class="add-to-link">
                                                <ul>
                                                    <li class="cart"><a class="cart-btn"
                                                                        onclick="add_to_cart(<?php echo $data['pro_id']; ?>)">ADD
                                                            TO CART </a></li>
                                                    ...
                                                    {
                                                        ?>
                                                                    <li class="cart"><a class="cart-btn" onclick="add_to_cart(<?php //echo $data['pro_id']; 
                                                        ?>)">ADD TO CART </a></li>
                                                                <?php
                                                    }
                                                    //else
                                                    {
                                                        ?>
                                                                <li class="cart"><a class="cart-btn" href="single_product.php?pro_id=<?php //echo $data['pro_id']; 
                                                        ?>">ADD TO CART </a></li>
                                                                <?php
                                                    }
                                                    ?> -->
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                                                    <div class="product-desc-wrap">
                                                        <div class="product-decs">
                                                            ...
                                                            <h2>
                                                                <a href="single_product.php?pro_id=<?php echo $data['pro_id']; ?>"
                                                                   class="product-link"><?php echo $data['pro_name']; ?></a>
                                                            </h2>
