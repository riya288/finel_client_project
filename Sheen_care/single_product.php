...
} elseif (isset($pro_id) && !empty($pro_id)) {
    // for display data
    $select = "SELECT * FROM stock JOIN product ON stock.pro_id = product.pro_id WHERE product.pro_id = '{$pro_id}'";
}
                    ...
                    if (!empty($single_image4)) {
                        ...
                        <a class="" data-image="admin/upload/product/<?php echo $single_image4; ?>"
                           data-zoom-image="admin/upload/product/<?php echo $single_image4; ?>">
                            <im
                                    g src="admin/upload/product/<?php echo $single_image4; ?>" alt="" class="h-brade"/>
                        </a>
                        <?php
                    }
                    ?>
                    ...
                    <?php if (isset($attribute) && !empty($attribute)) {
                        ...
                        for ($i = 0; $i < $count; $i++) {
                            ...
                            <div class="btn btn-small pricing-meta" style="background-color: #8e8a8a;"
                                 id="count<?= $i ?>" onclick="getprice(this.id)">
                                <li><?= $peice[$i] ?></li>
                            </div>
                        <?php }
                    }
...
if (isset($_SESSION['status'])) {
    if ($status_alert == "Please Login Again..") {
        ...
        <?php
    } elseif ($status_alert == "We are Comming soon Your Area..") {
        ?>
        <script>
            swal({
                title: "<?php echo $_SESSION['status']; ?>",
