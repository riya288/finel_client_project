            ...
            <div class="card-box mb-30">
                ...
                <div class="pb-20">
                    <table class="table hover multiple-select-row data-table-export nowrap">
                        ...
                        <tbody>
                        <?php
                        $select = "SELECT DISTINCT * FROM invoice RIGHT JOIN order_master ON invoice.order_id = order_master.order_id LEFT JOIN payment ON order_master.order_id = payment.order_id WHERE order_master.order_status = 'Pending' ORDER BY order_master.order_id DESC";
...
//                            $customer_data = mysqli_fetch_assoc($run2);
                            ...
                            <tr>
                                <td><a class="dropdown-item"
                                       href="update_pending_order.php?order_id=<?php echo $data['order_id']; ?>"><i
                                                class="dw dw-edit2"></i></a></td>
