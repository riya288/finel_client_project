...

{
	...
	$mini_banner_url = $_REQUEST['long_banner_url'];
...

  {
    ...
    $insert = "INSERT INTO long_banner(long_banner_image,long_banner_url) VALUES ('{$image_name}','{$mini_banner_url}')";
...

    {
      ...
      echo "<script> alert('Long Banner Added..!!'); 
					...
					<form action="" method="POST" enctype="multipart/form-data">
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								...
								<input class="form-control" name="long_banner_url" type="text" placeholder="Enter Url for click">
