                            ...
                            <form action="#">
                                ...
                                <div class="table-content table-responsive cart-table-content">
                                    ...
                                    <table>
                                        ...
                                        <tbody>
   <?php
                        $select = "SELECT DISTINCT * FROM invoice RIGHT JOIN order_master ON invoice.order_id = order_master.order_id LEFT JOIN payment ON order_master.order_id = payment.order_id WHERE order_master.customer_id = '$customer_id' ORDER BY order_master.order_id DESC";
