                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="breadcrumb-content">
                                ...
                                <h1 class="breadcrumb-hrading">Shop By Concern </h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12">
                            ...
                            <div class="shop-top-bar">
                                            ...
                                            $select ="SELECT * FROM product JOIN shop_product ON shop_product.pro_id = product.pro_id WHERE shop_product.category_id = '{$category_id}'";
