...
$dbss['user']='sheencar_blab123';      // Database user
$dbss['pass']='9pGS2M[O(9';      // Database password
$dbss['name']='sheencar_blab123';      // Database name. Note that the installation script cannot create a database for you!
$dbss['sock']='';      // Database socket
$dbss['prfx']='bbd3';      // Table prefix for chat tables: blab, blabws, blabax, blabwspro

// ---

$dbss['sprf']='bbd3';      /* Table prefix for shared chat tables (this should be the table prefix of the 'master' channel). 
...
$xcookie_uidhash = array('bbd3_uidhash',31536000);       // cookie to recognize logged in users
$xcookie_appcode = array('bbd3_appcode',31536000);       // cookie to BlaB! Q mobile app (integration only!)
$xcookie_langsel = array('bbd3_langsel',31536000);       // cookie to store language selection

$storage_options = 'bbd3_options';   // where to store options
$storage_xsounds = 'bbd3_xsounds';   // where to store sound options
$storage_ignored = 'bbd3_ignored';   // where to store ignored users
$storage_predefm = 'bbd3_predefm';   // where to store predefined messages
...
/* Additional integration variables - WordPress, Flarum & Vanilla  */
