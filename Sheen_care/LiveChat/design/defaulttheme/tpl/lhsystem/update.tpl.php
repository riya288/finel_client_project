...
<div class="row">
	<div class="col-md-4">
		...
		<a class="btn btn-secondary btn-xs" rel="noreferrer" href="http://livehelperchat.com/news-5c.html" target="_blank"><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('system/update','News')?></a>
		<a class="btn btn-secondary btn-xs" rel="noreferrer" href="http://livehelperchat.com/article/view/63" target="_blank"><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('system/update','Update instructions')?></a>
